...
export default class Geo {
  ...
  aabbIntersects (b) {
    let aminx = this.pos.x + this.aabb.min.x,
        ...
        aminy = this.pos.y + this.aabb.min.y,
  ...
  isPointOnLine (aa, ab, b) {
    var aTmp = new Point2(ab.x - aa.x, ab.y - aa.y),
        bTmp = new Point2(b.x - aa.x, b.y - aa.y)
  ...
  segmentsBBIntersect (aa, ab, ba, bb) {
    var firstbb = this.getSegmentBB(aa, ab),
        secondbb = this.getSegmentBB(ba, bb)
  ...
  intersectsWith (ogeo) {
    var i, oi, collision = false, points, opoints, point, prev, polyPos, oprev
